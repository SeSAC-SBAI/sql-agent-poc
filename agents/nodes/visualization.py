...
from utils.prompts.visualization import (
...
def determine_visualization(
    ...
    try:
        ...
        if viz_metadata["x_column"] not in columns or viz_metadata["y_column"] not in columns:
            return None
    ...
    try:
        ...
        if isinstance(sql_result, list):
            ...
            if "SELECT" in sql_query.upper():
                ...
                col_names = [f"col_{i}" for i in range(len(sql_result[0]))]
